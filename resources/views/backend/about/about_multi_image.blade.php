...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Add Multi Image</div>
        <div class="ps-3">
        ...
        <div class="main-body">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card p-3">
                        <div class="card-body">
                            <h4 class="mb-4">About Multi Image</h4>
                            ...
                            <form action="{{ route('store.multi.image') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="file" class="form-control" name="multi_image[]" id="multi_image" multiple/>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-primary px-4" value="Add Multi Image" />
                                    </div>
                                </div>
                            </form>
