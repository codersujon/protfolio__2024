...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Portfolio Edit</div>
        <div class="ps-3">
                            ...
                            <form action="{{ route('portfolio.update', $portfolio->id ) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" class="form-control" name="portfolio_name" value="{{ $portfolio->portfolio_name }}"/>
                                ...
                                <div class="row mb-3">
                                 ...
                                 <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img src="{{ (!empty($portfolio->portfolio_img))? url($portfolio->portfolio_img) : url('upload/No_Image.jpg') }}" class="p-1 rounded-circle" al t="user avatar" width="110" id="showImage">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <textarea class="form-control" id="portfolio_description"  name="portfolio_description" rows="2">{{ $portfolio->portfolio_description }}</textarea>
                                    </div>
                                </div>
