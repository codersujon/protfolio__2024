            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about__image">
                        <img src="{{ $aboutpage->about_image }}" alt="{{ $aboutpage->title }}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about__content">
                        ...
                        <a href="https://www.codersujon.com/CV/MD%20SUJAN%20AHMED.pdf" target="_blank" class="btn">Download my resume</a>
                    </div>
                </div>
            </div>
            <div class="row">
